      ...
      <div className="container flex items-center justify-between">
        ...
        >
          <span className="relative z-10">
            <span className="text-glow text-foreground">Kristian Haugen</span>{" "}
            Portfolio
          </span>
        </a>
        {/* desktop nav*/}
        ...
        <div
          className={cn(
            "fixed inset-0 bd-background/95 backdrop-blur-md z-40 flex felx-col items-center justify-center",
